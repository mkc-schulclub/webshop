<template>
    <div class="my-3 row filters mx-3">
        <div class="form-group col-lg-1" v-for="category in categories">
      ...
      <div class="container">
        <div class="row">
          <div
            ...
            :key="index"
            class="col-md-4 col-sm-6 mb-4 card"
  ...
  export default {
    ...
    data() {
      return {
        categories: ["T-Shirts", "Pullover", "Tassen",],
